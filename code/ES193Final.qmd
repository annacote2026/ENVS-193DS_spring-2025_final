...
## a. 
In this study, the 1s and 0s are distinguishing the different inhabitants of the nest boxes. The options are swift parrot, tree martin, common starling, and empty.
