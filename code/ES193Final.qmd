...
ggplot(data = tussocks_clean, 
       aes(x = site, # x-axis
           y = average_moss_cm, # y-axis
           color = site)) + # fill geoms by site (unburned vs burned)
  # first layer: boxplot
  geom_boxplot(color = "darkgrey", 
               outliers = FALSE) + # taking out outliers because they will be shown in the jitter
  # second layer: jitter
  geom_jitter(height = 0,
              width = 0.1, # making sure points are jittered horizontally
              size = 2,
              alpha = 0.6) +
  # set custom colors
  ...
  theme(legend.position = "none",
        ...
        panel.background = element_rect(fill = "white"), # coloring panel background white
        plot.background = element_rect(color = "white")) + # coloring plot background white
  labs(x = "Site", # label x-axis
       y = "Tussock mound height (cm)", # label y-axis
       title = "Site vs Tussock Mound Height", # give it a title
       subtitle = "Anna Cote") # give it a subtitle
